...
impl SpringConfig {
    const fn new(stiffness: f32, damping: f32, mass: f32) -> Self {
        Self {
            stiffness,
            damping,
            mass,
    ...
    fn step(&self, state: SpringState, target: f32, delta_time: f32) -> SpringState {
    ...
    fn is_settled(&self, state: SpringState, target: f32, epsilon: f32) -> bool {
